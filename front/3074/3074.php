...
<div class="row products">
    <div class="col-md-3 product">
        <div class="type-3189">
            <img class="img_product" alt="Shield Shampoo" height="300" src="./img/product-01-1-1-400x533.jpg"
                width="200" />
    ...
    <div class="col-md-3 product">
        <div class="type-3189">
            <img class="img_product" alt="Shield Shampoo" height="300" src="./img/product-02-1-1-400x533.jpg"
                width="200" />
            <div class="price">$45.00</div>
            <div class="name">Shield Shampoo</div>
            <div class="rating">
    ...
    <div class="col-md-3 product">
        <div class="type-3189">
            ...
            <img class="img_product" alt="Shield Shampoo" height="300" src="./img/product-03-1-1-400x533.jpg"
                width="200" />
            <div class="price">$45.00</div>
            <div class="name">Shield Shampoo</div>
            <div class="rating">
    ...
    <div class="col-md-3 product">
        <div class="type-3189">
            <img class="img_product" alt="Shield Shampoo" height="300" src="./img/product-06-1-1-400x533.jpg"
                width="200" />
            <div class="price">$45.00</div>
            <div class="name">Shield Shampoo</div>
            <div class="rating">
